...
public class SmoothPath {
    ...
    public SmoothPath(float fSpeed, float fStopDistance)
    {
        if (fSpeed > 0) {
            followerSpeed = fSpeed;
        } else {
            followerSpeed = 2.5f;
        }
        if (fStopDistance > 0) {
            followerStopDistance = fStopDistance;
        } else {
    ...
    /**
     * Set the look ahead distance (Increase/decrease).
     * @param by by how much +ve for increase & -ve for decrease
     */
    public void setLookAheadDistance(int by) {
        lookaheadDistance = lookaheadDistanceDelta * by;
    }
    ...
    /**
     * set the lookahead point from the provided coords
     * @param x
     * @param y
     */
    public void setlookaheadPoint(int x, int y)
    {
