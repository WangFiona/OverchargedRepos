...
@Disabled
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "Test1FlyWheelEncoderPower", group = "Tester")
public class Test1FlyWheelEncoderPower extends OpMode {
    ...
    private OcMotorEx InitializeMotor(String id, DcMotorEx.Direction direction) {
        ...
        //the following line makes the program not work
    ...
    public void loop() {
        ...
        telemetry.addData("LB(Power--), RB(Power++)", "x=0.4, y=0.6, b=0.8, a=1");
