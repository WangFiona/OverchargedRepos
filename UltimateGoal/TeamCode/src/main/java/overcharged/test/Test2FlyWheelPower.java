 ...
 */
@Disabled
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "Test2FlyWheelPower", group = "Tester")
public class Test2FlyWheelPower extends OpMode {
    ...
    public void init() {
        ...
        //Initialize Motors
        try {
            motorL = InitializeMotor("motorL", DcMotorEx.Direction.FORWARD);
            motorR = InitializeMotor("motorR", DcMotorEx.Direction.FORWARD);
    ...
    public void loop() {
        ...
        telemetry.addData("Power (" + power + ")", motorL.getPower() + " R:" + motorR.getPower());
        telemetry.addData("Velocity", numberFormatter.format(motorL.getVelocity()) + " VelocityR", numberFormatter.format(motorR.getVelocity()));
        telemetry.addData("EncoderL", motorL.getCurrentPosition() + " EncoderR:", motorR.getCurrentPosition());
        telemetry.update();
    }
}
