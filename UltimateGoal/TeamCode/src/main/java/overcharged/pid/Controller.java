package overcharged.pid;

import com.qualcomm.robotcore.util.RobotLog;

import static overcharged.config.RobotConstants.TAG_TD;

/// https://stemrobotics.cs.pdx.edu/node/7267?from=groupmessage&isappinstalled=0
/// https://raw.githubusercontent.com/stemrobotics/Tetrix-Exercises/master/PIDController.java
...
public class Controller
{
    ...
    private double m_tolerance = 0.2;      // the percentage error that is considered on target
    ...
    private void calculate()
    {
        ...
        if (m_enabled)
        {
            ...
            RobotLog.ii(TAG_TD, "PID_calculate() m_error=" + m_error+ "m_totalError="+ m_totalError+ "m_prevError="+m_prevError+"m_result="+m_result);
    ...
    {
        //RobotLog.ii(TAG_TD, "PID_onTarget() m_error=" + m_error+ "  m_tolerance="+m_tolerance+"   m_maximumInput="+m_maximumInput+"   m_minimumInput="+m_minimumInput);
